...
\label{sec:NLOUncertainties}
  ...
  \caption{Theoretical uncertainties for the next-to-leading order QCD predictions
...
\label{sec:PythiaAndNLO}
  ...
  \caption{Comparison of \textsc{Pythia8} prediction with the next-to-leading order QCD prediction of
