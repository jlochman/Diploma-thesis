...
\newcommand{\abstrCZ}{
  ...
  diferenci\'{a}ln\'{i}ho \'{u}\v{c}inn\'{e}ho pr\r{u}\v{r}ezu inkluzivn\'{i}ch jet\r{u} v
  ...
  Jsou pou\v{z}ity dv\v{e} metody unfoldingu, ozna\v{c}en\'{e} jako simple a 2D, a v\'{y}sledky z obou
  metod jsou vz\'{a}jemn\v{e} porovn\'{a}ny.
  Ob\v{e} metody mohou b\'{y}t pou\v{z}ity k unfoldov\'{a}n\'{i} diferenci\'{a}ln\'{i}ho
  \'{u}\v{c}inn\'{e}ho pr\r{u}\v{r}ezu
  inkluzivn\'{i}ch jet\r{u} m\v{e}\v{r}en\'{y}ch v Run~II experimentu ATLAS,
  kter\'{y} by m\v{e}l za\v{c}\'{i}t v l\'{e}t\v{e} 2015.
} 

\newcommand{\abstrEN}{
This thesis deals with the measurement of the inclusive jets double differential
...
prediction of the next-to-leading perturbative Chromodynamics.  
